...
;;; base16-pinkiepie-dark-theme.el

;;; Code:

(deftheme base16-pinkiepie-dark)
...
(let ((base00 "#151515")
  ...
  (custom-theme-set-faces 
   ...
   ;; Ruby
   `(enh-ruby-op-face ((t (:foreground ,base0D))))
...
(provide-theme 'base16-pinkiepie-dark)

;;; base16-pinkiepie-dark-theme.el ends here
