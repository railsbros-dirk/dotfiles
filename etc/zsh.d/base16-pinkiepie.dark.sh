#!/bin/sh
# Base16 PinkiePie - Console color setup script
# Dirk Breuer (http://tfcl.de)

color00="15/15/15" # Base 00 - Black
color01="ac/41/42" # Base 08 - Red
color02="90/a9/59" # Base 0B - Green
color03="fd/f6/af" # Base 0A - Yellow
color04="ed/45/8b" # Base 0D - Blue
color05="be/1d/77" # Base 0E - Magenta
color06="80/d1/f6" # Base 0C - Cyan
